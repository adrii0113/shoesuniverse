    ...
    useEffect(()=>{
        ...
        const loopRequest = async () =>{
            ...
            for (let index = 1; index < 101; index++) {
                ...
                const url = `https://api.themoviedb.org/3/movie/now_playing?api_key=${process.env.API_KEY}&page=${index}`
                const res = await axios.get(url)
                
                moviesTemp.push(res.data.results)
                
                // console.log(moviesTemp)
                setMovies(moviesTemp.slice(0,20))
        ...
        //     });
        // });
        // console.log(movies.map((movie)=>{console.log(movie)}))
        // console.log(movies)
...

            {
                movies.map((movieArray)=>(
                    ...
                    <div className="px-5 pb-5">
                        <a href="#">
                            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">aa</h5>
                        </a>
